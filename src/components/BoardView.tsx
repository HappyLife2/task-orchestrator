...
export default function BoardView({ boardId }: { boardId: string }) {
    ...
    const renderInlineCounter = (taskCount: number, subitemCount: number) => (
        <span className="text-[#9093a3] text-[15px] ml-1 font-medium tracking-wide opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap flex-shrink-0">
            ...
            <div className={`flex-1 flex flex-col transition-all duration-300 min-w-0 ${selectedTaskForUpdates ? 'mr-[450px]' : ''}`}>
                ...
                <div className="pl-8 pr-12 pt-8 pb-4 flex justify-between items-start sticky top-0 z-20 bg-background/80 backdrop-blur-xl border-b border-[var(--glass-border)]">
                    <div className="flex-1 pr-4">
                        <div className="w-auto min-w-max px-2" onClick={(e) => e.stopPropagation()}>
                            <EditableHeading
                                type="h2"
                                value={board.name}
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex items-center mr-2">
                            ...
                            {currentUser && ['ADMIN', 'OWNER'].includes(String(currentUser.role).toUpperCase()) && (
                                ...
                                >
                                    <div className="w-5 h-5 rounded-full border border-dashed border-white/40 flex items-center justify-center group-hover:border-white/60 transition-colors">
                                            ...
                                            <td colSpan={columns.length + 1} className="bg-transparent py-0">
                                                <div className="flex items-center gap-3 px-4 py-3.5 w-full group">
                                                    ...
                                                    <div className="flex items-center vibe-header-inherit" onClick={(e) => e.stopPropagation()}>
                                                        <div className="w-auto px-2 flex-shrink-0">
                                                            <EditableHeading
                                                                type="h3"
                                                                value={wipSectionName}
                                                                onChange={val => setWipSectionName(val || 'Active Tasks')}
                                                                className="!text-[#e0592a] !text-[14px] !font-bold !tracking-wide !font-outfit !whitespace-nowrap"
                                                            />
                                                        </div>
                                                            ...
                                                            <div className="flex items-center vibe-header-inherit" style={{ color: section.color }} onClick={(e) => e.stopPropagation()}>
                                                                <div className="w-auto px-2 flex-shrink-0">
                                                                    <EditableHeading
                                                                        ...
                                                                        className="!text-inherit !text-[14px] !font-bold !tracking-wide !font-outfit !whitespace-nowrap"
                                                                    />
                                                                </div>
                                                        ...
                                                        <div className="flex items-center vibe-header-inherit" onClick={(e) => e.stopPropagation()}>
                                                            <div className="w-auto px-2 flex-shrink-0">
                                                                <EditableHeading
                                                                    ...
                                                                    className="!text-[#00c875] !text-[14px] !font-bold !tracking-wide !font-outfit !whitespace-nowrap"
                                                                />
                                                            </div>
